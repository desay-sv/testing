...
describe User, models: true do
  ...
  describe 'projects' do
    before do
      ...
      @project_2 = create :empty_project, group: create(:group) # Grant MASTER access to the user
      @project_3 = create :empty_project, group: create(:group) # Grant DEVELOPER access to the user
  ...
  describe '#projects_where_can_admin_issues' do
    ...
    it 'includes projects for which the user access level is above or equal to reporter' do
      ...
      reporter_project = create(:empty_project)
      developer_project = create(:empty_project)
      master_project = create(:empty_project)
    ...
    it 'does not include for which the user access level is below reporter' do
      project = create(:empty_project)
      guest_project = create(:empty_project)
