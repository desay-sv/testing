  ...
  describe 'GET /dashboard/todos' do
    ...
    context 'User has Todos with labels spanning multiple projects' do
      before do
        ...
        project2 = create(:empty_project, visibility_level: Gitlab::VisibilityLevel::PUBLIC)
    ...
    context 'User has a Todo in a project pending deletion' do
      before do
        deleted_project = create(:empty_project, visibility_level: Gitlab::VisibilityLevel::PUBLIC, pending_delete: true)
