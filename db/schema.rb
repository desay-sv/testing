...
ActiveRecord::Schema.define(version: 20161202152035) do
  ...
  add_index "namespaces", ["parent_id"], name: "index_namespaces_on_parent_id", using: :btree
  ...
  add_index "routes", ["source_id", "source_type"], name: "index_routes_on_source_id_and_source_type", unique: true, using: :btree
  add_index "routes", ["source_type"], name: "index_routes_on_source_type", using: :btree
