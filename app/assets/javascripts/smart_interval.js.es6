...
(() => {
  class SmartInterval {
    ...
    handleVisibilityChange(e) {
      ...
      const state = this.state;
      const intervalAction = state.pageVisibility === 'hidden' ? this.onVisibilityHidden : this.onVisibilityVisible;
    ...
    incrementInterval() {
      ...
      if (cfg.hiddenInterval && this.state.pageVisibility === 'hidden') return;
